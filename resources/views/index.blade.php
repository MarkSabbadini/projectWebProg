        ...
        <div class="row justify-content-center align-items-center">
            <div class="col-lg-10 text-center">
                ...
                <div class="card shadow-sm border-0 p-4">
                    <p class="lead mb-0">
                        L’<strong>Unione Sportiva Corteno Golgi A.S.D.</strong> è un'associazione dilettantistica senza
                        scopo di lucro,
                        presente sul territorio da più di 50 anni con lo scopo principale di <strong>promuovere le attività
                            sportive</strong>
