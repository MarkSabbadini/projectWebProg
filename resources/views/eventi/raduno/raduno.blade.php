                    ...
                    @foreach($eventi_futuri as $entry)
                            ...
                            <div class="row mb-4 p-3 border rounded">
                                <div class="col-md-8">
                                    ...
                                    @else
                                        <a href="{{ route('raduno.iscrizione', ['evento' => $evento->id]) }}" class="btn btn-primary">Modulo
                                            iscrizione</a>
                                    @endif
                                </div>
                                <div class="col-md-4 text-end">
                        ...
                        <div class="row mb-4 p-3 border rounded bg-light">
                            <div class="col-md-8">
                                ...
                                @if(isset($utenteId) && !$evento->recensioni->contains('id_utente', $utenteId))
                                    <a href="{{ route('recensione.create', ['evento' => $evento->id]) }}"
