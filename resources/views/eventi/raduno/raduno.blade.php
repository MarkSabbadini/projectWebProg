...
@section('body')
    ...
    <div class="container mt-5">
        ...
        @if(isset($_SESSION['logged']) && $_SESSION['role'] === 'admin')
            <h3 class="mb-4">Gestione eventi Raduno</h3>
                            ...
                            @if($evento->locandina_path)
                                ...
                                @elseif(Str::endsWith($evento->locandina_path, ['.pdf']))
                                    <iframe src="{{ asset('storage/' . $evento->locandina_path) }}" width="100%" height="250px"
                                        style="border: none;" class="rounded shadow-sm"></iframe>
                                @endif
                            @endif
                        </div>
                    </div>
                        ...
                        <div class="card shadow-sm border-0 mb-4">
                            <div class="row g-0">
                                <div class="col-md-8 p-4">
                                    ...
                                    @else
                                        <a href="{{ route('raduno.iscrizione', $evento->id) }}" class="btn btn-primary btn-sm">Modulo iscrizione</a>
                                    @endif
                                </div>
                                <div class="col-md-4 d-flex align-items-center justify-content-center p-3">
                                    @if($evento->locandina_path)
                            ...
                            <div class="row g-0">
                                <div class="col-md-8 p-4">
                                    ...
                                    @if(isset($utenteId) && !$evento->recensioni->contains('id_utente', $utenteId))
                                        <a href="{{ route('recensione.create', $evento->id) }}"
                                           class="btn btn-outline-primary btn-sm mt-2">Aggiungi una recensione</a>
        ...
        @else
            ...
            <h3 class="mb-4">Eventi Raduno</h3>
            @foreach($raduno_list as $evento)
                <div class="card shadow-sm border-0 mb-4">
                    <div class="row g-0">
                        <div class="col-md-8 p-4">
